...
Latest deterministic balance history is authoritative. Account balance edits append history; entry edits/deletes recalculate current balance. Archived accounts reject new history and are excluded from active totals. Accounts with history or snapshot references cannot be permanently deleted.
