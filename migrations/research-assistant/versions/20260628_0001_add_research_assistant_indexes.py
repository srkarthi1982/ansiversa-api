"""add_research_assistant_indexes
...
INDEXES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("ResearchTopics_userId_updatedAt_title_idx", "ResearchTopics", ("userId", "updatedAt", "title")),
    ("ResearchNotes_topicId_position_createdAt_idx", "ResearchNotes", ("topicId", "position", "createdAt")),
    (
        "ResearchReferences_topicId_position_createdAt_idx",
        "ResearchReferences",
        ("topicId", "position", "createdAt"),
    ),
)
