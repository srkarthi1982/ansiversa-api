"""add_lesson_builder_indexes

Revision ID: 20260628_0001
Revises: 20260616_lesson_0003
...
down_revision: str | None = "20260616_lesson_0003"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


INDEXES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("LessonPlans_userId_updatedAt_title_idx", "LessonPlans", ("userId", "updatedAt", "title")),
    ("LessonPlans_userId_status_updatedAt_idx", "LessonPlans", ("userId", "status", "updatedAt")),
    ("LessonSections_lessonId_position_createdAt_idx", "LessonSections", ("lessonId", "position", "createdAt")),
)
