...
INDEXES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("StudyPlans_ownerId_updatedAt_title_idx", "StudyPlans", ("ownerId", "updatedAt", "title")),
    ("StudyPlans_ownerId_status_targetDate_idx", "StudyPlans", ("ownerId", "status", "targetDate")),
    ("StudyPlanTasks_ownerId_updatedAt_title_idx", "StudyPlanTasks", ("ownerId", "updatedAt", "title")),
    ("StudyPlanTasks_planId_status_idx", "StudyPlanTasks", ("planId", "status")),
    ("StudyLogs_ownerId_studyDate_createdAt_idx", "StudyLogs", ("ownerId", "studyDate", "createdAt")),
    ("StudyLogs_planId_ownerId_idx", "StudyLogs", ("planId", "ownerId")),
)
