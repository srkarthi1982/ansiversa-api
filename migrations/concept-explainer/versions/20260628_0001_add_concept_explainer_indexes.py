...
INDEXES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("Concepts_userId_updatedAt_title_idx", "Concepts", ("userId", "updatedAt", "title")),
    ("ConceptSteps_conceptId_position_createdAt_idx", "ConceptSteps", ("conceptId", "position", "createdAt")),
    ("ConceptChecks_conceptId_position_createdAt_idx", "ConceptChecks", ("conceptId", "position", "createdAt")),
)
