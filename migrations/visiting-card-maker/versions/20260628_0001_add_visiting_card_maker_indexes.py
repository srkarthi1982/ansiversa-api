"""add_visiting_card_maker_indexes
...
INDEXES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("CardDesigns_userId_updatedAt_idx", "CardDesigns", ("userId", "updatedAt")),
    ("CardDesigns_profileId_updatedAt_idx", "CardDesigns", ("profileId", "updatedAt")),
)
