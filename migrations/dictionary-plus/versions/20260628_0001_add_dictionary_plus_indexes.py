"""add_dictionary_plus_indexes

Revision ID: 20260628_0001
Revises: 20260621_dictionary_0001
...
down_revision: str | None = "20260621_dictionary_0001"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


INDEXES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("DictionaryLookups_userId_updatedAt_word_idx", "DictionaryLookups", ("userId", "updatedAt", "word")),
    ("SavedWords_userId_updatedAt_word_idx", "SavedWords", ("userId", "updatedAt", "word")),
    ("SavedWords_userId_lookupId_idx", "SavedWords", ("userId", "lookupId")),
    ("WordLists_userId_updatedAt_title_idx", "WordLists", ("userId", "updatedAt", "title")),
)
