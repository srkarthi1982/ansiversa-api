...
INDEXES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("Courses_ownerId_updatedAt_title_idx", "Courses", ("ownerId", "updatedAt", "title")),
    ("Courses_ownerId_status_targetDate_idx", "Courses", ("ownerId", "status", "targetDate")),
    ("CourseModules_ownerId_sequence_updatedAt_idx", "CourseModules", ("ownerId", "sequence", "updatedAt")),
    ("CourseModules_courseId_status_idx", "CourseModules", ("courseId", "status")),
    (
        "CourseProgressLogs_ownerId_progressDate_createdAt_idx",
        "CourseProgressLogs",
        ("ownerId", "progressDate", "createdAt"),
    ),
    ("CourseProgressLogs_courseId_ownerId_idx", "CourseProgressLogs", ("courseId", "ownerId")),
)
