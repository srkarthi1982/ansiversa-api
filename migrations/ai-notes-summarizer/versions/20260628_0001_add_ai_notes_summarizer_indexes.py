"""add_ai_notes_summarizer_indexes
...
INDEXES: tuple[tuple[str, str, tuple[str, ...]], ...] = (
    ("NotesDocuments_ownerId_updatedAt_title_idx", "NotesDocuments", ("ownerId", "updatedAt", "title")),
    ("NoteSummaries_documentId_createdAt_idx", "NoteSummaries", ("documentId", "createdAt")),
    ("NoteSummaries_ownerId_createdAt_idx", "NoteSummaries", ("ownerId", "createdAt")),
)
