...
`AstraIntentRequest`, parameters, `AstraIntentResolution`, and structural health are frozen, extra-forbidden metadata contracts. The action vocabulary is fixed:
