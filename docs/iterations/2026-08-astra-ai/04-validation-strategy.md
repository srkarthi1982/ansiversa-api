...
**Status:** Accepted for ASTRA-001 and ASTRA-002; ASTRA-003 ready for Product Owner approval
...
- ASTRA-003 status remains Completed until Product Owner approval and freeze;
- ASTRA-003 ADR remains ready for acceptance until Product Owner approval;
