...
| ASTRA-005 | Execution Planning And Action Governance | Critical | Proposed | Define declarative execution plans, actions, execution steps, approval gates, retry, rollback, compensation, cancellation, delegation, evidence, and planner/executor boundaries |
...
authorization and is pending Astra review. No implementation task should start
from ASTRA-004 or ASTRA-005 unless a separate implementation scope is
authorized.
