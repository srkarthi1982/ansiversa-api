...
- Admin users, admin roles, admin FAQ CRUD, audit log listing, permissions registry, dashboard write APIs, dashboard/activity webhooks, cross-app summaries, notification webhooks, and billing APIs remain intentionally deferred.
