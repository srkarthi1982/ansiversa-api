...
* 2026-06-30: Added Speech Writer App #038 backend foundation with repository/service architecture, isolated database configuration, owner-scoped CRUD APIs for projects, speeches, templates, and history, dashboard/detail response contracts, router registration, Alembic migration, overview metadata, local migration verification, and coming-soon story notes; no production migration or live promotion was run.
